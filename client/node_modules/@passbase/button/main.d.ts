...
export declare type RenderButtonFunction = (
/** The target element that Passbase Verification button will be rendered */
mountingElement: HTMLElement, 
/** The public API Key you obtained
 * from the developer dashboard. */
apiKey: string, options?: Partial<IframeInitMessageDataMain & ButtonCallbacks>) => void;
export declare type VerifyButtonComponent = (props: VerifyButtonProps) => JSX.Element;
export declare function start(): void;
declare const Passbase: {
	VerifyButton: VerifyButtonComponent;
	renderButton: RenderButtonFunction;
	start: typeof start;
};
export declare const VerifyButton: VerifyButtonComponent;
export default Passbase;

export as namespace Passbase;
