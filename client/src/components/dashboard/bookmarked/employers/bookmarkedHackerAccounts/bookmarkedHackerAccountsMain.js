...
const BookmarkedHackerAccountsAsEmployerHelper = ({ userData }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_BASE_URL}/gather/bookmarked/accounts/both/as/employer`, configuration).then((res) => {
            if (res.data.message === "Successfully gathered bookmarked hackers as employer account!") {
...
export default connect(mapStateToProps, {  })(BookmarkedHackerAccountsAsEmployerHelper);