...
const typesSelectionsOptions = [
    { label: "instruction-video", value: "instruction-video" }
]
const CustomInputHelper = ({ accept, onFiles, setCurrentFilePathData, setCurrentUploadFileStatus, setFileReadyStatus }) => {

    const text = "Select a video, image, gif, or really any other type of file you wish to share on your 'wall/profile'...";
