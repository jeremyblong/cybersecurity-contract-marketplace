...
const MessagingPanePrivateEmployerHelper = ({ messagePaneOpen, setMessagePaneState, employerName, SBData, userData, employerID }) => {
...
export default connect(mapStateToProps, { })(MessagingPanePrivateEmployerHelper);