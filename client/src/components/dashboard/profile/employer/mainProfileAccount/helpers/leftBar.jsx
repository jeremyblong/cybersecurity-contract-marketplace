                    ...
                    <Collapse isOpen={isProfile}>
                        <CardBody className="socialprofile filter-cards-view">
                            <Media><Media className="img-50 img-fluid m-r-20 rounded-circle" src={one} alt="" />
                                <Media body>
                                    <h6 className="font-primary f-w-600">{MyPage}</h6><span className="d-block"><span><i className="fa fa-comments-o"> </i><span className="px-2">Current Followers <span className="badge badge-pill badge-secondary" style={{ color: "#fff" }}>  {_.has(employerData, "currentlyFollowedBy") ? employerData.currentlyFollowedBy.length : 0}</span></span></span></span><span className="d-block"><span><i className="fa fa-bell-o"></i><span className="px-2">Following (Companies)<span className="badge badge-pill badge-secondary" style={{ color: "#fff" }}>   {_.has(employerData, "followingCompanies") ? employerData.followingCompanies.length : 0}</span></span></span></span>
                                </Media>
                            </Media>
