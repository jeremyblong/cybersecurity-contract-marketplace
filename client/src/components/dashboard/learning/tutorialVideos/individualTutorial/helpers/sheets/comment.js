...
const LeaveCommentTutorialVideoHelper = ({ selectedComment, setTutorialData, userData, tutorialID, isMessagePaneOpen, setMessagePaneOpenState }) => {
    ...
    const submitReply = () => {
        ...
        axios.post(`${process.env.REACT_APP_BASE_URL}/submit/comment/sub/reply/tutorial/video/content/response`, config).then((res) => {
            if (res.data.message === "Successfully left your comment on this tutorial!") {
...
export default LeaveCommentTutorialVideoHelper;