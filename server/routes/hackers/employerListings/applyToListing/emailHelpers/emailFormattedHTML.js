...
const sendEmailToEmployerNotifyingOfApplicantTemplate = (employerEmail, hackerFullName, profilePictureLink) => {
    const mailOptions = {
        ...
        * {
        ...
        <body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #deedfa;color: #000000">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="https://s3.amazonaws.com/unroll-images-production/projects%2F58128%2F1641917305276-pexels-david-mcbee-730564.jpg" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600"/>
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;"><em><strong>Submitted on: ${moment(new Date()).format("MM/DD/YYYY hh:mm:ss a")}</strong></em></p>
          </div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src=${profilePictureLink} alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 24%;max-width: 139.2px;" width="139.2"/>
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong>${hackerFullName}</strong></span></p>
          </div>
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 28px;">
            <strong>Here's some quick information for you!</strong>
          </h1>
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #333333; line-height: 170%; text-align: left; word-wrap: break-word;">
            <ul>
        <li style="font-size: 14px; line-height: 23.8px;"><strong>You've received a NEW applicant/application!</strong></li>
        <li style="font-size: 14px; line-height: 23.8px;"><strong>This is in relation to a job/gig that you've posted...&nbsp; </strong></li>
        <li style="font-size: 14px; line-height: 23.8px;"><strong>A hacker found your listing interesting & wants to potentially work for you!</strong></li>
        <li style="font-size: 14px; line-height: 23.8px;"><strong>Congratulations on receiving more inqueries, you seem to have posted a good listing! &nbsp;</strong></li>
        </ul>
          </div>
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px; font-family: Lato, sans-serif;">Congrat's on receiving your new applicant/application's! You should respond to these requests in a timely manner to maintain a good</span></p>
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px; font-family: Lato, sans-serif;"> repor within our communitity and retain high ratings/rankings within our automated "response timespan" calculations/system. Hacker's will know how long it typically takes you to respond so please consider this.</span></p>
          </div>
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #95a5a6; line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;"><span style="font-family: Lato, sans-serif; font-size: 14px; line-height: 19.6px;">&copy; 2023 ${config.get("applicationName")}. All Rights Reserved.</span></p>
          </div>
...
module.exports = {
    sendEmailToEmployerNotifyingOfApplicantTemplate
}