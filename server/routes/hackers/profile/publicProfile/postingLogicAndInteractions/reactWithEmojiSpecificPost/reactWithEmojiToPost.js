...
router.post("/", (req, resppppp, next) => {
    ...
    const { reaction, reactorID, posterID, relatedPosterPostID } = req.body;
    ...
    collection.findOne({ uniqueId: posterID }).then((user) => {
        if (!user) {
            ...
            // find relevant post..
            const findMatchingPostIndex = user.profilePosts.findIndex((post) => post.uniqueId === relatedPosterPostID);
