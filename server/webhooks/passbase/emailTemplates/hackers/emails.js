...
const verificationCompletedHackerEmail = (email) => {
    const mailOptions = {
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                                <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Hacker Account - Verification Completed!</h1> <img src=" https://img.icons8.com/clouds/100/000000/handshake.png" width="125" height="120" style="display: block; border: 0px;" />
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <p style="margin: 0;">You have successfully COMPLETED your "hacker account" verification requirements, we are continuously working on and reviewing incoming verifications on a daily basis. We understand you'd like to start applying to jobs/gigs and we are processing requests as quickly as possible - typically this usually takes anywhere from 1-3 days, please bear with us!</p>
                            </td>
                        </tr>
                        <tr>
...
const verificationReviewedAndApprovedHacker = (email) => {
    const mailOptions = {
        from: 'blongjeremy@gmail.com',
        to: email,
            ...
            <tr>
                <td bgcolor="#7366ff" align="center" style="padding: 0px 10px 0px 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                                <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Hacker Account - Verification Finished!</h1> <img src=" https://img.icons8.com/clouds/100/000000/handshake.png" width="125" height="120" style="display: block; border: 0px;" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <p style="margin: 0;">We're excited to inform you that we have VERIFIED your "hacker account" successfully and you now have FULL access to all features and functionality within our platform. User's on The Hacker Marketplace Inc. will also be able to see that you're verified now as well but more importantly qualifies you to apply for any work on our platform!</p>
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#ffffff" align="left">
...
const verificationReviewedAndDeniedHacker = (email) => {
    const mailOptions = {
        from: 'blongjeremy@gmail.com',
        to: email,
        subject: 'The Hacker Marketplace Inc. Verification Completed/Finished!',
