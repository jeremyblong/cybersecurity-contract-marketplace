...
const verificationCompletedEmployerEmail = (email) => {
    const mailOptions = {
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                                <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Employer Account - Verification Completed!</h1> <img src=" https://img.icons8.com/clouds/100/000000/handshake.png" width="125" height="120" style="display: block; border: 0px;" />
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <p style="margin: 0;">You have successfully COMPLETED your verification requirements as an EMPLOYER account, we are continuously working on and reviewing incoming verifications on a daily basis. We understand you'd like to be able to start posting work/listings and we are processing requests as quickly as possible - typically this usually takes anywhere from 1-3 days, please bear with us!</p>
                            </td>
                        </tr>
                        <tr>
...
const verificationReviewedAndApprovedEmployer = (email) => {
    const mailOptions = {
        from: 'blongjeremy@gmail.com',
        to: email,
            ...
            <tr>
                <td bgcolor="#7366ff" align="center" style="padding: 0px 10px 0px 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                                <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Employer Account - Verification Finished!</h1> <img src=" https://img.icons8.com/clouds/100/000000/handshake.png" width="125" height="120" style="display: block; border: 0px;" />
                            </td>
                        </tr>
                    </table>
                </td>
...
const verificationReviewedAndDeniedEmployer = (email) => {
    const mailOptions = {
        from: 'blongjeremy@gmail.com',
        to: email,
        subject: 'CyberHunt Verification Completed/Finished!',
