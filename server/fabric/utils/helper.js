...
const generateCertPath = async () => {
    ...
    const CHAINCODE_NAME = config.get("CHAINCODE_NAME");
    const CHAINCODE_VERSION = config.get("CHAINCODE_VERSION");
    const CHAINCODE_SEQUENCE = config.get("CHAINCODE_SEQUENCE");
    const ORDERER_NAME = config.get("ORDERER_NAME");
    const MSP_ID = config.get("MSP_ID");
    const PEER_NAME = config.get("PEER_NAME");
